...
const packageMap = {
  'darwin-x64': '@uk-hot/ccline-darwin-x64',
  'darwin-arm64': '@uk-hot/ccline-darwin-arm64',
  'linux-x64': '@uk-hot/ccline-linux-x64',
  'linux-x64-musl': '@uk-hot/ccline-linux-x64-musl',
  'linux-arm64': '@uk-hot/ccline-linux-arm64',
  'linux-arm64-musl': '@uk-hot/ccline-linux-arm64-musl',
  'win32-x64': '@uk-hot/ccline-win32-x64',
  'win32-ia32': '@uk-hot/ccline-win32-x64', // Use 64-bit for 32-bit systems
};
...
if (!fs.existsSync(binaryPath)) {
  ...
  console.error('Please try reinstalling: npm install -g @uk-hot/ccline');
